  ...
  useEffect(() => {
    setInterval(() => {
      if (media) {
        ...
        let barLength =
          audioBottomPlayhead.current.clientWidth *
          (media.current.currentTime / media.current.duration);
        ...
        <div id={"s-audio"}>
          ...
          <div id={"s-audio__bottom-c"}>
            <div id={"s-timer-loop-random-c"}>
              <img
                className={`s-random ${randomState}`}
                src={random}
                alt={""}
              ...
              <img
                className={`s-loop ${loopState ? "s-looping" : "not-looping"}`}
                src={loop}
                alt={""}
                onClick={toggleLoop}
              ></img>
            ...
            <div id={"s-audio__bottom"}>
              <div
                className={"s-audio__bottom__playhead"}
                ref={audioBottomPlayhead}
              >
                <div
                  className={"s-audio__bottom__playhead__left"}
                  ref={timerBar}
                ></div>
