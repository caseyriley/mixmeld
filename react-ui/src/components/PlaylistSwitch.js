...
const PlaylistSwitch = (props) => {
  return (
    <>
      {(() => {
        switch (
          props.playlistSwitchState ? props.playlistSwitchState : "Tracklist2"
        ) {
          case "Tracklist2":
            return (
              <Tracklist2
                ...
                selectedPlaylistState={props.selectedPlaylistState}
                playlistState={props.playlistState}
                playlistIdRef={props.playlistIdRef}
                addToPlaylistState={props.addToPlaylistState}
          ...
          case "Playlist2":
            return (
              <Playlist2
                ...
                trackArtState={props.trackArtState}
                setTrack={props.setTrack}
                playlistIdRef={props.playlistIdRef}
            ...
            return (
              <div id={"pl2-search-position"}>
                <SearchTracklist2
                  ...
                  setTrackViaSearch={props.setTrackViaSearch}
                  scrollToThis={props.scrollToThis}
                  scrollToThis2={props.scrollToThis2}
