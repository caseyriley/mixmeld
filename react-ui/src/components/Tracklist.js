    ...
    if (organiseByState === "id") {
      const getUserTracks = async () => {
        const response = await fetch(
          `${API_URL}/tracks/user/${currentUser.id}`,
          {
            method: "GET",
            mode: "cors",
      ...
      const getUserTracks = async () => {
        const response = await fetch(
          `${API_URL}/tracks/user/trackartist/${currentUser.id}`,
          {
            method: "GET",
            mode: "cors",
            headers: { Authorizaion: `Bearer ${token}` },
      ...
      const getUserTracks = async () => {
        const response = await fetch(
          `${API_URL}/tracks/user/trackrating/${currentUser.id}`,
          {
            method: "GET",
            mode: "cors",
            headers: { Authorizaion: `Bearer ${token}` },
      ...
      const getUserTracks = async () => {
        const response = await fetch(
          `${API_URL}/tracks/user/trackname/${currentUser.id}`,
          {
            method: "GET",
            mode: "cors",
            headers: { Authorizaion: `Bearer ${token}` },
      ...
      const getUserTracks = async () => {
        const response = await fetch(
          `${API_URL}/tracks/user/trackgenre/${currentUser.id}`,
          {
            method: "GET",
            mode: "cors",
            headers: { Authorizaion: `Bearer ${token}` },
      ...
      const getUserTracks = async () => {
        const response = await fetch(
          `${API_URL}/tracks/user/tracktime/${currentUser.id}`,
          {
            method: "GET",
            mode: "cors",
            headers: { Authorizaion: `Bearer ${token}` },
      ...
      <div id={"s-playlist-border"}>
        <div id={"s-playlist-c"}>
          <div id={"s-playlist-c__top-c"}>
            <div id={"s-playlist-c__top-c__rating"}>
              <h2
                onClick={() => {
                  setOrganiseByState("trackrating");
                }}
              >
                Rating
              </h2>
            ...
            <div id={"s-playlist-c__top-c__name"}>
              ...
              <img
                className={`s-tracklist-edit-pen ${
                  trackEditState ? "s-pen--on" : ""
                }`}
                src={pen}
                alt={""}
            ...
            <div id={"s-playlist-c__top-c__artist-name"}>
              <h2
                onClick={() => {
                  setOrganiseByState("trackartist");
                }}
              >
                Artist
              </h2>
            </div>
            <div id={"s-playlist-c__top-c__artist-duration"}>
              <h2
                onClick={() => {
                  setOrganiseByState("tracktime");
                }}
              >
                Time
              </h2>
            </div>
            <div id={"s-playlist-c__top-c__genre-name"}>
              <h2
                onClick={() => {
                  setOrganiseByState("trackgenre");
                }}
              >
                Genre
              </h2>
              ...
              ? trackArrayState.map((audio, index) => {
                  return (
                    <li className={"s-track-ul__li"} key={index}>
                      <div
                        className={`s-track-ul__li__rating ${
                          index % 2 === 1 ? "s-dark" : "s-light"
                        }`}
                      >
                        {trackEditState ? (
                          <form
                          ...
                          >
                            ...
                            />
                            <input
                              className={"s-track-artist-name-submit"}
                              type={"submit"}
                            />
                          </form>
                        ) : (
                          <span
                            className={"s-track-artist-rating-span"}
                            onClick={() => {
                              props.setTrack(
                                audio.tracklocation,
                                audio.tracklocation
                      ...
                      <div
                        className={`s-track-ul__li__name ${
                          index % 2 === 1 ? "s-dark" : "s-light"
                        }`}
                      >
                        {trackEditState ? (
                          ...
                          <span
                            className={"s-track-artist-name-span"}
                            onClick={() => {
                              props.setTrack(
                                audio.tracklocation,
                                audio.tracklocation
                      ...
                      <div
                        className={`s-track-ul__li__artist ${
                          index % 2 === 1 ? "s-dark" : "s-light"
                        }`}
                      >
                        {trackEditState ? (
                      ...
                      <div
                        className={`s-track-ul__li__duration ${
                          index % 2 === 1 ? "s-dark" : "s-light"
                        }`}
                      >
                      ...
                      <div
                        className={`s-track-ul__li__genre ${
                          index % 2 === 1 ? "s-dark" : "s-light"
                        }`}
                      >
                        {trackEditState ? (
