...
const Tracklist2 = (props) => {
  ...
  const getUserTracks = async (path) => {
    ...
    const response = await fetch(
      `${API_URL}/tracks/user/${path}/${currentUser.id}`,
      {
        method: "GET",
        mode: "cors",
        headers: { Authorizaion: `Bearer ${token}` },
  ...
  const getUserTracksReverse = async (path) => {
    ...
    if (!response.ok) {
      console.log("error iiiiiin getUserTracks");
    } else {
      const json = await response.json();
  ...
  const [organiseByState, setOrganiseByState] = useState({
    1: "date",
    2: "",
    3: false,
  });
  ...
  return (
    <>
      {props.uploadModalState === "upload-modal" ? (
        <UploadModal
          currentUser={currentUser}
          refreshTrackState={props.refreshTrackState}
          setRefreshTrackState={props.setRefreshTrackState}
          uploadModalState={props.uploadModalState}
          setUploadModalState={props.setUploadModalState}
      ...
      <div id={"pl2-playlist-border"} className={"fade-in-2"}>
        <div id={"pl2-playlist-c"}>
          <div id={"pl2-playlist-c__top-c"}>
            <div id={"pl2-playlist-c__top-c__rating"}>
              <h2
                onClick={() => {
                  organise("trackrating");
                }}
              >
                Rating
              </h2>
            ...
            <div id={"pl2-playlist-c__top-c__name"}>
              <div
                id={"pl2-uploading-track-visibility"}
                className={`${props.addToPlaylistState ? "hidden" : "visible"}`}
              >
                <UploadingTrackPl2
                  refreshTrackState={props.refreshTrackState}
                  setRefreshTrackState={props.setRefreshTrackState}
              ...
              <img
                className={`pl2-tracklist-edit-pen ${
                  props.trackEditState ? "pl2-pen--on" : ""
                } ${props.addToPlaylistState ? "hidden" : "visible"}`}
                src={pen}
                alt={""}
                onClick={toggleTrackEditState}
              />
            </div>
            <div id={"pl2-playlist-c__top-c__artist-name"}>
              <h2
                onClick={() => {
                  organise("trackartist");
                }}
              >
                Artist
              </h2>
            </div>
            <div id={"pl2-playlist-c__top-c__album-name"}>
              <h2
                onClick={() => {
                  organise("trackalbum");
                }}
            ...
            <div id={"pl2-playlist-c__top-c__artist-duration"}>
              <h2
                onClick={() => {
                  organise("tracktime");
                }}
            ...
            <div id={"pl2-playlist-c__top-c__genre-name"}>
              <h2
                onClick={() => {
                  organise("trackgenre");
                }}
            ...
            <div id={"pl2-playlist-c__top-c__date"}>
              <h2
                onClick={() => {
                  organise("date");
                }}
          ...
          <div id={"pl2-track-ul-c"}>
            <ul id={"pl2-track-ul"}>
              {trackArrayState
                ? trackArrayState.map((audio, index) => {
                    return (
                      <li
                        name={index}
                        className={"pl2-track-ul__li"}
                        key={index}
                      >
                        <div
                          id={`nti${index}`}
                        ...
                        <div
                          className={`pl2-track-ul__li__rating ${
                            index % 2 === 1 ? "pl2-dark" : "pl2-light"
                          }`}
                        >
                          <div
                            className={"pl2-track-artist-rating__div"}
                            onClick={() => {
                              launchTrackRatingModal(audio);
                            }}
                          >
                            <span className={"pl2-track-artist-rating-span"}>
                              {audio.trackrating ? audio.trackrating : ""}
                            </span>
                          </div>
                        </div>

                        <div
                          className={`pl2-track-ul__li__name ${
                            index % 2 === 1 ? "pl2-dark" : "pl2-light"
                          }`}
                        >
                          ...
                          !playlistIdState.includes(audio.id) ? (
                            <img
                              ...
                              alt={""}
                              onClick={(e) => {
                                addToPlaylistFunc(e.target.name);
                              }}
                            />
                          ) : null}
                            ...
                            <>
                              ...
                              >
                                <input
                                  ...
                                  maxLength={100}
                                  placeholder={
                                    audio.trackname ? audio.trackname : ""
                                  }
                                />
                                <input
                                  className={"pl2-track-artist-name-submit"}
                                  type={"submit"}
                                />
                              </form>
                              <img
                                name={audio.id}
                                className={"pl2-deleteX"}
                                src={deleteX}
                                alt={""}
                                onClick={(e) => {
                                  deleteTrack(e.target.name);
                                }}
                              />
                            </>
                          ) : (
                            <span
                              className={"pl2-track-artist-name-span"}
                              onClick={() => {
                                props.setTrack(
                                  audio.tracklocation,
                                  audio.trackname,
                        ...
                        <div
                          className={`pl2-track-ul__li__artist ${
                            index % 2 === 1 ? "pl2-dark" : "pl2-light"
                          }`}
                        >
                          {props.trackEditState ? (
                            ...
                            >
                              <input
                                ...
                                maxLength={100}
                                placeholder={
                                  audio.trackartist ? audio.trackartist : ""
                                }
                              />
                              <input
                                className={"pl2-track-artist-name-submit"}
                            ...
                            <span
                              className={"pl2-track-artist-span"}
                              onClick={() => {
                                props.setTrack(
                                  audio.tracklocation,
                                  audio.trackname,
                        ...
                        <div
                          className={`pl2-track-ul__li__album ${
                            index % 2 === 1 ? "pl2-dark" : "pl2-light"
                          }`}
                        >
                          {props.trackEditState ? (
                            ...
                            >
                              <input
                                ...
                                maxLength={100}
                                placeholder={
                                  audio.trackalbum ? audio.trackalbum : ""
                                }
                              />
                              <input
                                className={"pl2-track-artist-name-submit"}
                        ...
                        <div
                          className={`pl2-track-ul__li__duration ${
                            index % 2 === 1 ? "pl2-dark" : "pl2-light"
                          }`}
                        >
                          <span>{audio.tracktime ? audio.tracktime : ""}</span>
                        </div>

                        <div
                          className={`pl2-track-ul__li__genre ${
                            index % 2 === 1 ? "pl2-dark" : "pl2-light"
                          }`}
                        >
                          {props.trackEditState ? (
                            ...
                            >
                              <input
                                ...
                                maxLength={100}
                                placeholder={
                                  audio.trackgenre ? audio.trackgenre : ""
                                }
                              />
                              <input
                                className={"pl2-track-artist-name-submit"}
                            ...
                            <span
                              className={"pl2-track-genre-span"}
                              onClick={() => {
                                props.setTrack(
                                  audio.tracklocation,
                                  audio.trackname,
                        ...
                        <div
                          className={`pl2-track-ul__li__date ${
                            index % 2 === 1 ? "pl2-dark" : "pl2-light"
                          }`}
                        >
                          <span
                          ...
                          >
                            {audio.created_date
                              ? audio.created_date.slice(5, 16) +
                                " " +
                                toStandardTime(audio.created_date.slice(16, 22))
                              : ""}{" "}
                          </span>
                        </div>
                      </li>
