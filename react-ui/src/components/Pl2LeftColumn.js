    ...
    <>
      {playlistModalState ? (
        <NewPlaylistModal
          ...
          setRefreshPlaylistState={props.setRefreshPlaylistState}
          refreshPlaylistState={props.refreshPlaylistState}
        />
      ) : null}
      <div id={"pl2-left-column"} className={"fade-in"}>
        <div id={"pl2-search"}>
          <input
            id={"pl2-search__input"}
            type={"text"}
            placeholder={"search"}
        ...
        <div id={"pl2-left-column__scroll-outer"}>
          <div id={"pl2-left-column__scroll-inner"}>
            <div
              className={`${
                props.artistAlbumSongState === "selected-artist"
                  ? "selected-artist"
                  : ""
              } select-artist`}
              onClick={() => {
                props.setArtistAlbumSongState("selected-artist");
                props.showPl2ArtistPage();
              }}
            >
            ...
            <div
              className={`${
                props.artistAlbumSongState === "selected-album"
                  ? "selected-album"
                  : ""
              } select-album`}
              onClick={() => {
                props.setArtistAlbumSongState("selected-album");
                props.showPl2AlbumPage();
              }}
            >
            ...
            <div
              className={`${
                props.artistAlbumSongState === "selected-song"
                  ? "selected-song"
                  : ""
              } select-song`}
              onClick={() => {
                props.setArtistAlbumSongState("selected-song");
                props.showTracklist();
              }}
            >
            ...
            <div
              className={`add-to-playlist ${
                props.addToPlaylistState ? "add-to-playlist--on" : ""
              }`}
              onClick={() => {
                props.toggleAddToPlaylist();
                selectFirstPlaylist();
              }}
            >
            ...
            <div
              className={`left-playlist-inst ${
                props.addToPlaylistState ? "visible" : "hidden"
              }`}
            >
              <p>
                <span>select a playlist below then </span>{" "}
                <span>
                  add tracks by clicking the
                  <img
                    className={"left-playlist-inst-add"}
                    src={circlePlusHollow}
                    alt={""}
                  />
                  icon.
                </span>
            ...
            <div
              className={`${props.addToPlaylistState ? "visible" : "hidden"}`}
            >
              {props.playlistState
                ? props.playlistState.map((playlist, index) => {
                    return (
                      <div
                        ...
                        name={`${playlist.id}`}
                        className={`${
                          props.playlistIdRef.current.playlistId === playlist.id
                            ? "playlist-highlight"
                            : ""
                        } playlist-button-c`}
                        onClick={() => {
