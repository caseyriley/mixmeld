  ...
  function updateTrackInfo(e) {
    const newTrack = async () => {
      ...
      const trackData = {
        ...
        tracklocation: props.trackLocationState,
      };
      const options = {
        method: "POST",
  ...
  return ReactDom.createPortal(
    ...
    >
      <div className={"upload-modal"}>
        ...
        <span id={"upload-modal-instructions"}>
          Enter your tracks info here and upload a image. You can always edit
          your tracks info later.
        </span>
        <UploadingImage
