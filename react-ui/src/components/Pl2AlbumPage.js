      ...
      return (
        <div ke={1000 + kii} className={"pl2-album-c"}>
          ...
          <div className={"pl2-album-info-c"}>
            ...
            <h3 className={"pl2-album-artist"}>By {album[0].trackartist}</h3>
            ...
            { album.map((track, index) => {
                  return (
                    ...
                    <div key={100000 + index}>
                      ...
                      <h3 className={"pl2-album-track"} onClick={()=>{props.setTrack(track.tracklocation, track.trackname, track.trackartist, track.id, track.trackart)}}>{track.trackname}</h3>
                    </div>
